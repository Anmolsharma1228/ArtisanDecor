...
export default function AboutPage() {
  return (
    <section className="max-w-7xl mx-auto px-6 py-8 md:py-20 text-gray-800 mt-6 md:mt-10 select-none">
      {/* Heading */}
      <motion.div
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <div className="bg-linear-to-br from-orange-50 to-green-50 p-8 rounded-2xl shadow">
          ...
          <p className="text-gray-700">
            ...
            design, we create décor solutions that blend timeless artistry with
            contemporary living. Every element is carefully considered to bring
            warmth, harmony, and character to each space.
          </p>
        </div>
